...
public:
	...
	{
		this->program = CShaderLoader::CreateProgram("Resources/Shaders/Model.vs", "Resources/Shaders/Model.fs");
	...
	void Render(CObject* actor)
	{
		for (GLuint i = 0; i < this->meshes.size(); i++) {

		//printf("mesh size: %d \n", meshes.size());

			this->meshes[i].Render(camera, program, actor);
		}
	}
