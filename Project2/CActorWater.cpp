#include "CActorWater.h"

CActorWater::CActorWater(GLint* _program, GLuint* _VAO, int _indiceCount, CCamera* _gameCamera, GLuint* _texture, FMOD::System* _audioSystem)
	: CObject(_program, _VAO, _indiceCount, _gameCamera, _texture)
{
	...
	actorPlane = new CPlane();
}

CActorWater::~CActorWater()
{
}

void CActorWater::TextureGen(const char* textureLocation, GLuint* texture)
{
